 ...
 */
static char font[] = "Deja Vu Sans Mono for Powerline:pixelsize=14:autohint=true";
...
static Key key[] = {
        ...
        { XK_Up,            ShiftMask|ControlMask, "\033[1;8A",     0,    0,    0},
        { XK_Up,            ShiftMask|Mod1Mask,    "\033[1;9A",     0,    0,    0},
        ...
        { XK_Down,          ShiftMask|ControlMask, "\033[1;8B",     0,    0,    0},
        { XK_Down,          ShiftMask|Mod1Mask,    "\033[1;9B",     0,    0,    0},
        ...
        { XK_Left,          ShiftMask|ControlMask, "\033[1;8D",     0,    0,    0},
        { XK_Left,          ShiftMask|Mod1Mask,    "\033[1;9D",     0,    0,    0},
        ...
        { XK_Right,         ShiftMask|ControlMask, "\033[1;8C",     0,    0,    0},
        { XK_Right,         ShiftMask|Mod1Mask,    "\033[1;9C",     0,    0,    0},
