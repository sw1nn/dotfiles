...
(custom-theme-set-faces
 ...
 '(compilation-line-number ((t (:inherit font-lock-keyword-face :foreground "#259185"))))
 '(eldoc-highlight-function-argument ((t (:inherit bold :foreground "#859900" :weight bold))))
 ...
 '(flyspell-incorrect ((t (:underline (:color "Red4" :style wave)))))
 ...
 '(font-lock-doc-face ((t (:inherit font-lock-string-face :foreground "#259185"))))
 ...
 '(highlight ((t (:background "#0a2832" :inverse-video t))))
 ...
 '(mode-line ((t (:weight bold :box nil :foreground "DarkGreen" :background "OliveDrab2"))))
 '(mode-line-buffer-id ((t (:weight bold :foreground "blue4"))))
 '(mode-line-inactive ((t (:weight normal :box nil :foreground "black" :background "gray20" :inherit (mode-line)))))
 ...
 '(isearch ((t (:inverse-video t :foreground "#a57705" :background "#042028"))))
