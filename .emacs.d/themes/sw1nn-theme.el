...
(custom-theme-set-faces
 ...
 '(diff-refine-added ((t (:inherit diff-refine-change :background "#548b54"))))
 ...
 '(font-lock-warning-face ((t (:underline (:color "#8b0000" :style wave)))))
 ...
 '(nrepl-error-highlight-face ((t (:underline (:color "#8b0000" :style wave) :inherit nil))))
 '(nrepl-warning-highlight-face ((t (:underline (:color "#8b7500" :style wave) :inherit nil))))
